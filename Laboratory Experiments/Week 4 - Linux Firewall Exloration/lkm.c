...
unsigned int telnet_outgoing(void *priv, struct sk_buff *skb, const struct nf_hook_state *state)
{
	...
	if (iph->protocol == IPPROTO_TCP && tcph->dest == htons(23) && iph->saddr == in_aton("10.0.2.13") && iph->daddr==in_aton("10.0.2.14")) {
...
unsigned int ssh_outgoing(void *priv, struct sk_buff *skb, const struct nf_hook_state *state)
{
	...
	if (iph->protocol == IPPROTO_TCP &&  tcph->dest == htons(22) && iph->saddr == in_aton("10.0.2.13") && iph->daddr==in_aton("10.0.2.14")) {
...
unsigned int telnet_incoming(void *priv, struct sk_buff *skb, const struct nf_hook_state *state)
{
	...
	if (iph->protocol == IPPROTO_TCP && tcph->dest == htons(23) && iph->saddr == in_aton("10.0.2.14") && iph->daddr==in_aton("10.0.2.13")) {
...
unsigned int ssh_incoming(void *priv, struct sk_buff *skb, const struct nf_hook_state *state)
{
	...
	if (iph->protocol == IPPROTO_TCP && tcph->dest == htons(22) && iph->saddr == in_aton("10.0.2.14") && iph->daddr==in_aton("10.0.2.13")) {
...
unsigned int web_block(void *priv, struct sk_buff *skb, const struct nf_hook_state *state)
{
	...
	if (iph->protocol == IPPROTO_TCP && iph->saddr == in_aton("10.0.2.13") && iph->daddr==in_aton("52.172.204.196") && (tcph->dest == htons(80) || tcph->dest == htons(443)) ) {
